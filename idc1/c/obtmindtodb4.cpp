...
bool CZHOBTMIND::InsertTable()
{
  if (m_stmt.m_state==0)
  {
    ...
    m_stmt.prepare("insert into t_zhobtind(obtid,ddatetime,t,p,u,wd,wf,r,vis) values(:1,str_to_date(:2,'%%Y%%m%%d%%H%%i%%s'),:3,:4,:5,:6,:7,:8,:9)");
...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/project/tools1/bin/procctl 10 /project/idc1/bin/obtmindtodb /idcdata/surfdata \"127.0.0.1,root,20020914,mysql,3306\" utf8 /log/idc/obtmindtodb.log\n\n");
