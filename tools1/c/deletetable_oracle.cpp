...
//1.程序的帮助
//2.oracle不需要为查询语句创建专用的数据库连接
//3.oracle不需要用MAXPARAMS宏
...
void _help(char *argv[])
{
  ...
  printf("Sample:/project/tools1/bin/procctl 3600 /project/tools1/bin/deletetable_oracle /log/idc/deletetable_oracle_ZHOBTMIND1.log \"<connstr>qxidc/qxidcpwd@oracle_wyz</connstr><tname>T_ZHOBTMIND1</tname><keycol>keyid</keycol><where>where ddatetime<sysdate-0.03</where><starttime>01,02,03,04,05,13</starttime><timeout>120</timeout><pname>deletetable_ZHOBTMIND1</pname>\"\n\n");
