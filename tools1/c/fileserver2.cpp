...
void RecvFilesMain();
bool RecvFile(const int sockfd,const char *filename,const char *m_time,int filesize);
  ...
  while (true)
  {
    ...
    if (strncmp(strrecvbuffer,"<filename>",10)==0)
    {
      ...
      GetXMLBuffer(strrecvbuffer,"size",&filesize);
			...
			//吧文件名中的clientpath替换成srvpath，要小心第三个参数
