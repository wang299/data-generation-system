/*
 *  程序名：syncincrement_oracle.cpp，本程序是数据中心的公共功能模块，采用增量的方法同步MySQL数据库之间的表。
 *  作者：吴从周。
*/
...
struct st_arg
{
  ...
  char lnktname[31];       // lnktnamed表名。后面加@db132
...
void _help(char *argv[])
{
  printf("Using:/project/tools1/bin/syncincrement logfilename xmlbuffer\n\n");
	...
	printf("       /project/tools1/bin/procctl 10 /project/tools1/bin/syncincrement_oracle /log/idc/syncincrement_oracle_ZHOBTMIND3.log \"<localconnstr>scott/20020914@oracle_wyz</localconnstr><remoteconnstr>qxidc/qxidcpwd@oracle_wyz</remoteconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><remotetname>T_ZHOBTMIND1</remotetname><lnktname>T_ZHOBTMIND1@db132</lnktname><localtname>T_ZHOBTMIND3</localtname><remotecols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</remotecols><localcols>obtid,ddatetime,t,p,u,wd,wf,r,vis,upttime,keyid</localcols><where>and obtid like '54%%%%'</where><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><maxcount>300</maxcount><timetvl>2</timetvl><timeout>50</timeout><pname>syncincrement1_ZHOBTMIND3_oracle</pname>\"\n\n");
